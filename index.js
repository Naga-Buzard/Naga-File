...
//
const BotName = 'Drawl Bot 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/fws.grup'; // Nama Instagramlu cok
const whatsapplu = '0813-5730-2007'; // Nomor whatsapplu cok
const kapanbotaktif = 'Gak tau lah serah serah gw :v'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Dorw1sAujPv18d9nBkd9vZ'; // OFFICIAL GRUP KE 1
const grupch2 = 'https://chat.whatsapp.com/Jb93uvhAbbGKkUXMos0Ej3'; // OFFICIAL GRUP KE 2
//
const
{
   WAConnection,
